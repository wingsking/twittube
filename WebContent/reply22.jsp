				...
				<div class="containers">
					...
					<div class="rows">
						...
						<!-- Banner -->
							...
							<footer>
								<a href="#myModal" class="button alt">Reply</a>
							</footer>
						</div>
					</div>
				</div>
  		...
  		<div class="modal-dialog">
    		<div class="modal-content">
      			...
      			<div class="modal-body">
        			<form class="form-horizontal" ACTION="upload.jsp" ENCTYPE="multipart/form-data" method="Post">
						<div class="form-group">
  					    ...
  					    <div class="form-group">
					    	<label for="info" class="col-sm-2 control-label">Intro</label>
					    	<div class="col-sm-10">
					      		<textarea row="3" class="form-control" id="info" name="video_info" placeholder="Brief intro"></textarea>
					    	</div>
					  	</div>
					  	<div class="form-group">
										...
										<% for(Video v:replies){%>
											<div class="4u">
												<section class="box">
													...
													<div id='<%=v.getName() %>'></div>
													<script type="text/javascript">
										   			jwplayer('<%=v.getName() %>').setup({
